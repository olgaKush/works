...
(function ($) {
    $.fn.progressTimer = function (options) {
        ...
        this.each(function () {
            ...
            var timeLeftContainer = $("<p>");
            timeLeftContainer.appendTo($(this));
            ...
            var interval = window.setInterval(function () {
                ...
                var left = settings.timeLimit - Math.floor(elapsed / 1000); 
                // bar.text(sformat(left));
                timeLeftContainer.text("Time left " + sformat(left));
